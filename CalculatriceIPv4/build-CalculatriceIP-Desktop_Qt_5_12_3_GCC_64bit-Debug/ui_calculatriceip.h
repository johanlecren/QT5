...
public:
    ...
    void setupUi(QMainWindow *CalculatriceIP)
    {
        if (CalculatriceIP->objectName().isEmpty())
            CalculatriceIP->setObjectName(QString::fromUtf8("CalculatriceIP"));
        ...
        lineEdit_adr_ip->setObjectName(QString::fromUtf8("lineEdit_adr_ip"));
        ...
        lineEdit_adr_diffusion->setObjectName(QString::fromUtf8("lineEdit_adr_diffusion"));
        ...
        pushButtonPropos->setObjectName(QString::fromUtf8("pushButtonPropos"));
        ...
        menuCalculatrice_IPv4->setObjectName(QString::fromUtf8("menuCalculatrice_IPv4"));
